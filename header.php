  ...
  <header class="header">
    <div class="header__inner">
      ...
      <nav class="header__nav">
        <a href="<?php echo esc_url(get_post_type_archive_link('about')); ?>" class="header__link">About Eye Herb</a>
        <a href="<?php echo esc_url(get_post_type_archive_link('menu')); ?>" class="header__link">Menu</a>
        <a href="<?php echo esc_url(get_post_type_archive_link('before-after')); ?>" class="header__link">Before/After</a>
        <a href="<?php echo esc_url(get_post_type_archive_link('recruit')); ?>" class="header__link">Recruit</a>
        <a href="<?php echo esc_url(get_post_type_archive_link('contact')); ?>" class="header__link">Contact</a>
      </nav>
